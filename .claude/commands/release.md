...
You are preparing a new release for the **Magic Notifications** Flutter plugin. Follow this checklist precisely:
...
**Full Changelog**: https://github.com/fluttersdk/magic_notifications/compare/{previous_tag}...{version}
NOTES
)"
```
...
**GitHub Release:** https://github.com/fluttersdk/magic_notifications/releases/tag/{version}
...
**pub.dev:** ✅ Validate passed → Published (run #{publish_run_id}) — https://pub.dev/packages/magic_notifications
```
